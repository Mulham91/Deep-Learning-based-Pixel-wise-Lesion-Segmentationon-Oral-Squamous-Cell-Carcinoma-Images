...
def get_colored_segmentation_image(seg_arr, n_classes, colors=[(0,0,0), (0,255,0),(0,0,255)]):
...
def visualize_segmentation(seg_arr, inp_img=None, n_classes=None,
                           colors=[(0,0,0), (0,255,0),(0,0,255)], class_names=None,
    ...
    seg_img = get_colored_segmentation_image(seg_arr, n_classes, colors=[(0,0,0), (0,255,0),(0,0,255)])
    ...
    if show_legends:
        ...
        legend_img = get_legends(class_names, colors=[(0,0,0), (0,255,0),(0,0,255)])
...
def predict(model=None, inp=None, out_fname=None,
            ...
            class_names=None, show_legends=False, colors=[(0,0,0), (0,255,0),(0,0,255)],
            prediction_width=None, prediction_height=None):
    ...
    seg_img = visualize_segmentation(pr, inp, n_classes=n_classes,
                                     colors=[(0,0,0), (0,255,0),(0,0,255)], overlay_img=overlay_img,
...
def predict_multiple(model=None, inps=None, inp_dir=None, out_dir=None,
    ...
    for i, inp in enumerate(tqdm(inps)):
        ...
        pr = predict(model, inp, out_fname,
                     ...
                     show_legends=show_legends, colors=[(0,0,0), (0,255,0),(0,0,255)],
                     prediction_width=prediction_width,
                     prediction_height=prediction_height)
